...
function App() {
  ...
  React.useEffect(() => {
    ...
    // const firstIndexLosses = listOfWins.filter(elem => elem['loser'] === orderedSeasonsList[currentIndex].title)
    // const secondIndexWins = listOfWins.filter(elem => elem['winner'] === orderedSeasonsList[currentIndex + 1].title)
    // const secondIndexLosses = listOfWins.filter(elem => elem['loser'] === orderedSeasonsList[currentIndex + 1].title)


    const didFirstBeatSecond = firstIndexWins.filter( elem => elem.loser === orderedSeasonsList[currentIndex + 1].title).length > 0

    if(didFirstBeatSecond) {
